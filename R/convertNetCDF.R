...
convertNetCDF <- function(odf, metadata, filename = NULL, debug=0, data=NULL){
  ...
  ncdf4::ncatt_put(ncout, 0, "time_coverage_duration", (tail(odf[['time']], n = 1) - odf[['time']][[1]]))
  ...
  ncdf4::ncatt_put(ncout, 0, "time_coverage_end", as.character(as.POSIXct(tail(odf[['time']], n= 1))))
