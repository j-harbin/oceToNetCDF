...
singleAdpNetCDF <- function(adp, name, debug=0, data=NULL, destination="."){
  ...
  ncdf4::ncatt_put(ncout, 0, "title", adp[['title']])
    ...
    depthMax <- adp[["depthMax"]]
    if (exists("depthMax")) {
      ncdf4::ncatt_put(ncout, 0, "instrument_depth", adp[['depthMax']])
    }
    ...
    ncdf4::ncatt_put(ncout, 0, "filename", adp[['filename']])
    ncdf4::ncatt_put(ncout, 0, "model", adp[['model']])
    ncdf4::ncatt_put(ncout, 0, "orientation", adp[['orientation']])
    ncdf4::ncatt_put(ncout, 0, "serialNumber", adp[['serialNumber']])
    ncdf4::ncatt_put(ncout, 0, "water_depth", adp[['waterDepth']])
    ncdf4::ncatt_put(ncout, 0, "country_institute_code", adp[['countryInstituteCode']])
    ncdf4::ncatt_put(ncout, 0, "institute", adp[['institute']])
    ncdf4::ncatt_put(ncout, 0, "number_of_beams", adp[['numberOfBeams']])
    ncdf4::ncatt_put(ncout, 0, "sample_interval", adp[['sampleInterval']])
    ncdf4::ncatt_put(ncout, 0, "ship", adp[['ship']])
    ncdf4::ncatt_put(ncout, 0, "station", adp[['station']])
    ncdf4::ncatt_put(ncout, 0, "cruise",adp[['cruise']])
    ncdf4::ncatt_put(ncout, 0, "type", adp[['type']])
    ncdf4::ncatt_put(ncout, 0, "cruise_number", adp[['cruiseNumber']])
    ncdf4::ncatt_put(ncout, 0, "depth_off_bottom",adp[['depthOffBottom']])
    ncdf4::ncatt_put(ncout, 0, "source", adp[['source']])
