...
It's important to note for RCM files, code HCDT (Horizontal current direction (true)) does not have a CF standard. The standard name has been added as horizontal_current_direction. Additionally, unlike mCTD files, no data ranges are being checked. It's recommended that the user investigates the data themselves.
